...
\begin{enumerate}
    ...
    There are $3$ leftmost \& rightmost derivations each (total = $6$) for this string because there are $3$ potential starting positions and no branching decisions. For example, the $2$ leftmost derivations would be:

    \includegraphics[scale = 0.50]{4.5}
